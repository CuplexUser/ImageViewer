...
{
    private static readonly byte[] RndBytes =
    {
        0x8E, 0x51, 0xEB, 0x52, 0x7C, 0xA0, 0x1, 0xE1,
    ...
    {
        var deriveBytes = new Rfc2898DeriveBytes(password, RndBytes, 1000, HashAlgorithmName.SHA256);
        byte[] dataBytes = deriveBytes.GetBytes(512);
        deriveBytes.Dispose();
