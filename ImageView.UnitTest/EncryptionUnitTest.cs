...
namespace ImageViewer.UnitTests
{
    ...
    public class EncryptionUnitTest
    {
        ...
        {
            string hex= "";
            ...
            {
                uint numericaVal = BitConverter.ToUInt32(byteBufferResult, i);
                extrapolatedString.Append(numericaVal);
            }

            string result = extrapolatedString.ToString();
            extrapolatedString.Clear();
            Console.WriteLine(result);
            Assert.IsTrue(result.Length == 512, "Result wasnt expected");
            //string number= hex.ToString(IFormatProvider)
        }
    }
}